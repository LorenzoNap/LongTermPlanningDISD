...
Row {.tabset .tabset-fade data-width=200} 
-------------------------------------
### Cluster 1    
```{r}
renderDygraph({
...
```{r}
renderValueBox({
  valueBox(total[2,]$NumeroVoli, icon = "fa-car", color = "orange")
})
```
...
```{r}
renderValueBox({
  valueBox(total[3,]$NumeroVoli, icon = "fa-car", color = "primary")
})
```
